...
const EditorPage = () => {
  ...
  return (
    <div className="flex h-screen bg-slate-50 font-sans overflow-hidden">
      {/* Desktop Sidebar */}
      <aside className="hidden md:flex h-full w-80 flex-shrink-0 border-r border-slate-200 bg-white overflow-y-auto">
        <ChapterSidebar
          book={book}
          ...
          <div className="flex items-center justify-between px-4 py-3">
            ...
            <div className="flex items-center gap-3">
              ...
              <Button
                ...
                isLoading={isSaving}
                icon={Save}
                className="bg-gradient-to-r from-violet-500 to-purple-600 hover:from-violet-600 hover:to-purple-700 text-white font-medium rounded-lg shadow-md hover:shadow-lg px-4 py-2 transition-all duration-200"
              >
                Save Changes
              </Button>
            </div>
